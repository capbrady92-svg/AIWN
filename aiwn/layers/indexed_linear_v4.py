// Fix Ubuntu 24.04 + CUDA 12.8 glibc math header conflict
// cospi/sinpi/rsqrt exception specification mismatch between
// /usr/include/x86_64-linux-gnu/bits/mathcalls.h and CUDA math_functions.h
#define __THROW
